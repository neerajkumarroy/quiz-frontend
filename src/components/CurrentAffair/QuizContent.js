...
const QuizContent = () => {
    ...
    const [timeRemaining, setTimeRemaining] = useState(660); // 660 seconds for 11 minutes
    ...
    const handleSubmit = () => {
        ...
        navigate('/results', { state: { totalQuestions, correctCount, incorrectQuestions, percentage, attemptedQuestions } });
    };
        ...
        <div className="quiz-content">
                ...
                <>
                    ...
                    <div className="initial-popup">
                        <div className="popup-content">
                            <h2>Welcome to the Current Affairs Quiz</h2>
            ...
            {!showInitialPopup && (
                <>
                    ...
                    <h2 className='title-name'>Current Affaires Quiz</h2>
