...
const ReactResult = () => {
    ...
    // Function to navigate back to the React quiz page with correct answers highlighted
    const handleReviewQuiz = () => {
        navigate('/quiz/react-review', { state: { correctAnswers } }); // Ensure the path matches your route configuration
    };

    return (
        <div className="results-page">
            <div className="results-card">
                <h2>React Quiz Results</h2>
                ...
                <button
                    onClick={() => navigate('/quiz/react')} // Adjust the path as needed
